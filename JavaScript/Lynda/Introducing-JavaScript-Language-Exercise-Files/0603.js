function speakSomething(what, howMany) {
	...
	var what = (typeof what !== 'undefined') ? what : 'Default speech'; // if what is undefined, provide default value
	var howMany = (typeof howMany !== 'undefined') ? howMany : 10; // if howMany is undefined, provide default value
